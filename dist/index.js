...
module.exports = {
   ...
   dev: {
      deploy: function deploy(cfg) {
         return new d(_extends({}, cfg, { endpoint: 'https://qf7gz2uqq2.execute-api.us-west-2.amazonaws.com/dev', slug: 'deploy' }));
      },
      plans: function plans(cfg) {
         return new a(_extends({}, cfg, { endpoint: 'https://nof8onrfef.execute-api.us-west-2.amazonaws.com/dev', slug: 'plans' }));
      },
      email: function email(cfg) {
         return new e(_extends({}, cfg, { endpoint: 'https://wmg82tv0ka.execute-api.us-west-2.amazonaws.com/dev', slug: 'email' }));
      },
      users: function users(cfg) {
